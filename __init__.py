...
sbar = st.sidebar
page = sbar.radio("Select Page",options=['Home','Generate README','Editor'])
if page == 'Home':
    ...
    - Copy the code (there is a button on the top right corner of the code section to cop all)
    - If you are happy with the Readme, you can download it
    - If you wish to make changes, Go the 'Editor' Page and paste the Markdown
    - It is Autoupdated 
    ''')
